...
import { discount, robot , robot_hand} from "../assets";
...
const Hero = () => {
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          ...
          Revolutionize Your Business with <br className="sm:block hidden" />{" "}
            ...
            <TypingAnimation words={words}  textSize= "text-7xl" />
          </h1>
  ...
  <img 
    src={robot_hand} 
    alt="billing" 
    className="w-[90%] h-[100%] relative z-[5] mr-[10%] rounded-[10%] border-2 border-gray-300 shadow-lg transform transition-all duration-500 ease-in-out hover:-translate-y-1 hover:scale-105 sm:ml-4" 
    style={{ boxShadow: '0 0 10px 5px lightblue' }}
  />
  {/* gradient start */}
